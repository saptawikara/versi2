...
CoolClock.config = {
	...
	skins:	{
		...
		tobyLight: {
		outerBorder:      { lineWidth: 8, radius: 65, color: "#C7C7C7", alpha: 1 },
		...
		hourHand:         { lineWidth: 8, startAt: -5, endAt: 45, color: "black", alpha: 1 },
		minuteHand:       { lineWidth: 6, startAt: -5, endAt: 55, color: "black", alpha: 1 },
		secondHand:       { lineWidth: 2, startAt: -5, endAt: 50, color: "red", alpha: 1 },
		secondDecoration: { lineWidth: 1, startAt: 70, radius: 4, fillColor: "red", color: "red", alpha: 0 }
	},

		toby: {
		outerBorder:      { lineWidth: 8, radius: 65, color: "#32333A", alpha: 1 },
		smallIndicator:   { lineWidth: 0, startAt: 0, endAt: 0, color: "black", alpha: 0 },
		largeIndicator:   { lineWidth: 0, startAt: 0, endAt: 0, color: "black", alpha: 0 },
		hourHand:         { lineWidth: 8, startAt: -5, endAt: 45, color: "black", alpha: 1 },
		minuteHand:       { lineWidth: 6, startAt: -5, endAt: 55, color: "black", alpha: 1 },
